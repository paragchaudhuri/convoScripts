...
# Make sure the iAvatar file is named as <rollnumber>-<scarfcolour>-<glass/noglass> like 170502009-green
...
glass_mesh_name = "Sun_Glasses"; 
glass_frame_material_name = "Sun_Glasses";
glass_lens_material_name = "Sun_Glasses_len";
glass_exists=False;
...
def update_on_avatar_change():
	global ui, all_avatars, student_avatar, student_name, scarf_name, glass_exists;
